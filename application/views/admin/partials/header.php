...
<head>
    ...
    <title>JalousieScout | Dashboard</title>
   ...
   <link rel="stylesheet" href="<?php echo base_url('assets/libs/summernote/summernote-bs4.css') ?>">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="#" class="logo">
            ...
            <span class="logo-mini">JSSA</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>JS Shop Admin</b></span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview <?php echo ($this->uri->segment(2) == "pages")? " active": ""; ?>">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo base_url('index.php/admin/pages'); ?>"><i class="fa fa-circle-o"></i> All</a></li>
                        <!-- <li><a href="<?php echo base_url('index.php/admin/pages/create'); ?>"><i class="fa fa-circle-o"></i> Add</a></li> -->
                    </ul>
                </li>
                ...
                <li class="treeview <?php echo ($this->uri->segment(2) == "Attribute Set")? " active": ""; ?>">
                    <a href="#">
                        <i class="fa fa-list"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo base_url('index.php/admin/attributes'); ?>"><i class="fa fa-circle-o"></i> All</a></li>
                        <li><a href="<?php echo base_url('index.php/admin/attributes/create'); ?>"><i class="fa fa-circle-o"></i> Add</a></li>
                    </ul>
                </li>
